<?php
	...
	//import
	require 'connect.php';
	$sql = "INSERT INTO exch812_history(thb, calculated, currency) VALUES ($thb, $result, '$type')";
	 	...
	 	<div class="container">
	 		...
	 		<?php
				...
				echo "<br>";
		 		...
		 		$sql = "SELECT * FROM exch812_history ORDER BY dateRecord DESC";
		 		$sql_exe = $conn -> query($sql);
		 	...
		 	<table class="table table-striped table-hover">
			 	...
			 	?>
			 					...
			 					<td><a <?php echo 'href="delete.php?id='.$row['recordID'].'&thb='.$row['thb'].'"' ?>><button type="button" class="btn btn-danger">Delete</button>
</a></td>
			 				 </tr>
